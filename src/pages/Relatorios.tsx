  ...
  return (
    <>
      ...
      <section className="mb-[18px] grid grid-cols-[2fr_1fr] gap-4 max-[1080px]:grid-cols-1">
        <div className="animate-rise rounded-card border border-line bg-card p-5 shadow-panel">
        ...
        <div className="animate-rise rounded-card border border-line bg-card p-5 shadow-panel" style={{ animationDelay: '.06s' }}>
      ...
      <section className="animate-rise rounded-card border border-line bg-card p-5 shadow-panel" style={{ animationDelay: '.1s' }}>
