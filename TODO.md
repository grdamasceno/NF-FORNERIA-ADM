...
- [ ] Atualizar `VITE_SUPABASE_URL` pra `https://supabase.onchannel.io` nas Environment Variables da Vercel e redeployar — só depois disso o login/Franquias/Configurações voltam a funcionar em produção (ainda não confirmado)
